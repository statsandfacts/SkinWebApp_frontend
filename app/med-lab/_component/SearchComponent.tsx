...
const SearchComponent = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-50 rounded-lg p-6">
      <WelcomeSection />
      <div className="flex justify-center w-full sm:w-1/2 gap-5 md:gap-10 max-w-3xl mb-4 mt-10">
        <div
        ...
        >
          <h2 className="text-xs sm:text-xl font-semibold">Search Medicine</h2>
        </div>
