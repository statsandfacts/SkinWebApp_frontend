  ...
  return (
    <>
      <CommonHeroSection
        key={"abdm-hero"}
        title="Ayushman Bharat Digital Mission"
        subtitle="Empowering every Indian with access to digital healthcare and wellness solutions."
      />
        ...
        <section className="mt-10 text-white transform hover:scale-[1.02] animate-slide-up transition-transform duration-300 ease-in-out flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="mt-4 text-lg text-slate-700">
              ...
              Create your unique health ID today and connect to India’s
              futuristic healthcare services.
            </p>
            <Link
        ...
        <section className="mt-10 text-white transform hover:scale-[1.02] animate-slide-up transition-transform duration-300 ease-in-out flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2">
            ...
            <p className="mt-4 text-lg text-slate-700">
              ...
              initiative aimed at transforming the Indian healthcare ecosystem.
              By enabling the creation of digital health IDs, it seeks to
              empower citizens with secure and convenient access to their
              medical information, bridging the gap between patients, doctors,
