          ...
          <li>
            ...
            <div>
              ...
              <ul className="ps-5 mt-2 space-y-1 list-disc list-inside">
                ...
                <li>
                  Medical history and information provided during consultations
                </li>
          ...
          <li>
            ...
            <div>
              ...
              <ul className="ps-5 mt-2 space-y-1 list-disc list-inside">
                ...
                <li>
                  Communicate with Users about their consultations and
          ...
          <li>
            ...
            <div>
              ...
              <ul className="ps-5 mt-2 space-y-1 list-disc list-inside">
                ...
                <li>
                  Service providers and third-party partners who assist us in
                  operating the Platform and providing services
                </li>
                <li>
                  Legal and regulatory authorities as required by law or in
          ...
          <li>
            ...
            <div>
              <p className="ml-4 text-md">
                ...
                that your child has provided personal information, please
          ...
          <li>
            ...
            <div>
              <p className="ml-4 text-md">
                ...
                Your continued use of the Platform after the posting of changes
