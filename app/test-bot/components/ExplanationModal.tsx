              ...
              <ModalBody className="px-10">
                ...
                >
                  {ExplanationData && ExplanationData?.content.length > 1 ? (
                    ExplanationData?.content.map((data, index) => (
                      <div key={index}>
                        ...
                        <li
                          key={index}
                          className={`${ExplanationData?.colors[index]} list-none pl-4 relative before:content-['•'] before:absolute before:left-0 before:text-black mb-2`}
                        >
                          {data}
                        </li>
                      </div>
