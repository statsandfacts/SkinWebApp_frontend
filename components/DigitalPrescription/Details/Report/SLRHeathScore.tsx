...
export default function SLRHealthScore() {
  ...
  const score =
    singleReport.data?.data?.slr_res?.total_health_score ?? 0;
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 md:p-10 rounded-2xl shadow-lg bg-white w-full max-w-5xl mx-auto mt-4">
      {/* Text Content */}
