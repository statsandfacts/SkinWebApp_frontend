...
export default function AllReports() {
  ...
  if (!groupedResults)
    return <div className="p-6 text-center">Loading or no report found.</div>;

  // track active tabs per group
  const initialTabs = groupedResults.reduce((acc, g) => {
  ...
  return (
    <div className="space-y-12 p-6 max-w-6xl mx-auto">
      {groupedResults.map((g) => {
        const activeTab = activeTabs[g.group_name];
