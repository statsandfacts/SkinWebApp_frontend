...
import { DotButton, useDotButton } from '../Home/EmblaCarouselDotButton';
import { NextButton, PrevButton, usePrevNextButtons } from '../Home/EmblaCarouselArrowButtons';
    ...
    <section className=' overflow-hidden max-w-[90%] md:max-w-full p-0 md:p-10'>
      <div className='embla w-full' ref={emblaRef}>
        <div className='embla__container'>
          {COMMON.DIGITAL_PRESCRIPTION_SLIDER_ITEMS.map((item, index) => (
